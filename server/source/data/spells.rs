...
pub struct SpellData {
    ...
    pub min_carisma: i32,
    pub max_carisma: i32,
    // Hunger/thirst effects (VB6: SubeHam/SubeSed — 1=restore, 2=damage)
    pub sube_ham: i32,
    pub min_ham: i32,
    pub max_ham: i32,
    pub sube_sed: i32,
...
pub fn load_spells(base: &Path) -> Result<Vec<SpellData>, String> {
    ...
    for i in 1..=num_spells {
        ...
        let spell = SpellData {
            ...
            sube_carisma: get_int("SubeCA"),
            min_carisma: get_int("MinCA"),
            max_carisma: get_int("MaxCA"),
            sube_ham: get_int("SubeHam"),
            min_ham: get_int("MinHam"),
            max_ham: get_int("MaxHam"),
            sube_sed: get_int("SubeSed"),
            min_sed: get_int("MinSed"),
            max_sed: get_int("MaxSed"),
