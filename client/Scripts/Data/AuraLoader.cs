...
{
    public int ProceduralStyle; // 0=legacy GRH, 1=orbits, 2=petals, 3=solar, 4=crystals, 5=static GM warp
...
public static class AuraLoader
{
    public static AuraData[] Load(IResourceProvider resources)
    {
        ...
        for (int i = 1; i <= count; i++)
        {
            ...
            auras[i].ProceduralStyle = Math.Clamp(ini.GetInt(section, "ProceduralStyle", 0), 0, 5);
